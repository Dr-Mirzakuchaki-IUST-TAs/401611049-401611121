...
set rc [catch {
  ...
  add_files -quiet {{E:/MSc.Iran university of science and technology/Term 1/VHDL/Project/controller/CTRL/CTRL.runs/synth_1/Top_module.dcp}}
  link_design -top Top_module -part xc7s50ftgb196-2
